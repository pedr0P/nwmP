...
inline __attribute__((unused)) const struct {
    ...
    { MODKEY,             XK_q,               spawn,          termcmd },
    { MODKEY,             XK_r,               spawn,          dmenucmd },
    { MODKEY,             XK_b,               spawn,          browser },
    { MODKEY,             XK_t,               toggle_bar,     NULL },
    ...
    { MODKEY,             XK_i,               focus_next,     NULL },
    { MODKEY,             XK_m,               focus_prev,     NULL },
    { MODKEY | ShiftMask, XK_n,               swap_prev,      NULL },
    { MODKEY | ShiftMask, XK_e,               swap_next,      NULL },

    { MODKEY,             XK_m,               resize_master,  (void*)-RESIZE_STEP },
    { MODKEY,             XK_i,               resize_master,  (void*)RESIZE_STEP },
    ...
    { MODKEY|ShiftMask,   XK_t,          increment_scroll_visible, NULL },
    { MODKEY|ControlMask,    XK_t,          decrement_scroll_visible, NULL },
    ...
    { MODKEY | ShiftMask | ControlMask, XK_f,               quit_wm,        NULL },
    // { MODKEY | ShiftMask | ControlMask, XK_r,               quit_wm,        (void*)1 },
};
